...
<head>
    ...
    <link rel="stylesheet" href="./jspackage/layui/css/layui.css"  media="all">
	<!-- 表格 -->
...
<!--[if lt IE 9]>
    <script src="jspackage/json2/json2.js"></script>
<![endif]-->
</head>
<body scoll=no>
	<div id="setmap"></div>
...
<div id="controlGroup" class="dn" style="position:absolute;top:10px;">
	<div class="layui-form">
		<!--
		<div class="controlGroup-panel-title">								
			
			<div id="div_groupupdown_select" class="fl" style="margin-left:10px;"></div>
			<div class="fl" style="margin-left:10px;">	
...
<!-- showMonitorWall End -->
    ...
    <!-- showPanelPlc start -->
<!--    <div id="showMonitorWall_CMSupload" class="dn" style="position:absolute;top:10%;left: 10px;">-->
<!--        <div class="layui-form">-->
<!--            <div class="panel-group">-->
<!--                <div id="onscreen_panel">-->
<!--                    --><?php
...
<!--    <div class="ch"></div>-->
    ...
    <!-- showPanelPlc start -->
    <div id="showMonitorWall_CMS" class="dn" style="position:absolute;top:30px;">
        <div class="layui-form">
            <div class="panel-group">
                <div id="onscreen_panel">
                    <div class="layui-form-item">
                        <label class="layui-form-label">亮度值:</label>
                        <div class="layui-input-inline">
                            <input id="CMS_light" type="text"  required lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                </div>
            </div>
